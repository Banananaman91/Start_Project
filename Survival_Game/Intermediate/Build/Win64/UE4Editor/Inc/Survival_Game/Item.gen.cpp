...
// Cross Module References
	...
	SURVIVAL_GAME_API UEnum* Z_Construct_UEnum_Survival_Game_EItemRarity();
...
// End Cross Module References
	...
	static UEnum* EItemRarity_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Survival_Game_EItemRarity, Z_Construct_UPackage__Script_Survival_Game(), TEXT("EItemRarity"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EItemRarity(EItemRarity_StaticEnum, TEXT("/Script/Survival_Game"), TEXT("EItemRarity"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Survival_Game_EItemRarity_Hash() { return 3620433296U; }
	UEnum* Z_Construct_UEnum_Survival_Game_EItemRarity()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Survival_Game();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EItemRarity"), 0, Get_Z_Construct_UEnum_Survival_Game_EItemRarity_Hash(), false);
#else
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "EItemRarity::IR_VeryRare", (int64)EItemRarity::IR_VeryRare },
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "IR_VeryRare.Name", "EItemRarity::IR_VeryRare" },
				{ "ModuleRelativePath", "Items/Item.h" },
			};
#endif
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UItem_GetStackWeight_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Item_eventGetStackWeight_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
...
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_itemToolTip;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UItem_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UItem_GetStackWeight, "GetStackWeight" }, // 149222462
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UItem_Statics::NewProp_itemRarity_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UItem_Statics::NewProp_itemRarity_MetaData[] = {
		{ "Category", "Item" },
		{ "ModuleRelativePath", "Items/Item.h" },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UItem_Statics::NewProp_itemRarity = { "itemRarity", nullptr, (EPropertyFlags)0x0010000000010005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UItem, itemRarity), Z_Construct_UEnum_Survival_Game_EItemRarity, METADATA_PARAMS(Z_Construct_UClass_UItem_Statics::NewProp_itemRarity_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UItem_Statics::NewProp_itemRarity_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UItem_Statics::NewProp_itemToolTip_MetaData[] = {
		{ "Category", "Item" },
		{ "ModuleRelativePath", "Items/Item.h" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_UItem_Statics::NewProp_itemToolTip = { "itemToolTip", nullptr, (EPropertyFlags)0x0014000000010005, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UItem, itemToolTip), Z_Construct_UClass_UItemToolTipWidget_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UItem_Statics::NewProp_itemToolTip_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UItem_Statics::NewProp_itemToolTip_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UItem_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UItem_Statics::NewProp_itemRarity_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UItem_Statics::NewProp_itemRarity,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UItem_Statics::NewProp_itemToolTip,
	...
	IMPLEMENT_CLASS(UItem, 1480370665);
